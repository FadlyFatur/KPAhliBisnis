...
<div id="menu-area">
        <div class="banner">
            <div class="content">
                ...
                <a href="#" class="button button3"><img src="<?php echo e(URL::asset('assets/img/Button pesan sekarang.png')); ?>"></a>
                <a href="#" class="button button4"><img src="<?php echo e(URL::asset('assets/img/BUTTON KONTAK KAMI.png')); ?>"></a>
            </div>
    ...
    <section class="jasaproduk">
        <div class="produk">
            ...
            <div class="container">
                <div class="jasaPusat">
                    <div>
                        <img src="<?php echo e(URL::asset('assets/img/assets/icon1.png')); ?>">
                    </div>
                </div>
                <div class="jasaview1">
                    <div>
    ...
    <section class="services">
        ...
        <div class="container">
            <div class="serviceBx1">
                <div>
                    <img src="<?php echo e(URL::asset('assets/img/kOTAK TABEL MERAH.png')); ?>">
    ...
    <section class="jasadesign">
        <div class="design">
            ...
            <div class="container">
                <div class="jasaview1">
                    <div>
                        <img src="<?php echo e(URL::asset('assets/img/KOTAK TABEL KUNING.png')); ?>">
...
<?php echo $__env->make('layouts.frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Aplikasi\xampp\htdocs\Laravel\Laravel\resources\views/home/awal.blade.php ENDPATH**/ ?>