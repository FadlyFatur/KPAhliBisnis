    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          ...
          @else
          <div class="btn-group">
            <button type="button" class="btn dropdown-toggle btn-nav" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <!-- cart -->
        <a class="nav-item nav-link btn-nav" href="{{route('detailProduk.keranjang')}}">
